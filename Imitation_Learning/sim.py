...
class WallESim:
    ...
    def move_robot(self, action: Action):
        ...
        pos_robot, pos_ori = pos_0, ori_0
        # TODO: Implement the robot movements given action
        # =================================================
        # =================================================
        if action == Action.FORWARD:
            pos_robot = [0, -pos_delta, 0]
            pos_ori = p.getQuaternionFromEuler([0,0,0])
        elif action == Action.RIGHT:
            pos_robot = [0, 0, 0]
            pos_ori = p.getQuaternionFromEuler([0,0,-rot_delta])
            ...
            pos_robot = [0, 0, 0]
            pos_ori = p.getQuaternionFromEuler([0,0,rot_delta])
        pos_n, ori_n = p.multiplyTransforms(pos_0, ori_0, pos_robot, pos_ori)
